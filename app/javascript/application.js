...
// Function to apply wobbling effect with rotation from bottom and subtly varied swaying
...
// Event listener for Turbo Drive to ensure animations run on each page load
document.addEventListener("turbo:load", function() {
    // Select the element with the tree-hp id
